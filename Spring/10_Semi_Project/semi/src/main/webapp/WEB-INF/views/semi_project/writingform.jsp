...
<td><input type=text value="${sessionID}" readonly="readonly" name="product_member" class="w3-input"></td></tr>

<tr><td style="text-align:center">제   목</td>
<td><input type=text name="product_title" class="w3-input"></td></tr>

<tr>
<td>제품명</td>
<td><input type=text name="product_name" class="w3-input">
...
<td><textarea rows="15" cols="45" name="product_info" class="w3-input"></textarea></td></tr>

<tr><td style="text-align:center">이미지</td>
<td><input type=file name="product_image"></td></tr>

<tr><td style="text-align:center">가  격</td>
<td><input type=text name="product_price" class="w3-input"></td></tr>

<tr class="w3-center w3-large w3-margin-top">
<td colspan="2"><input type=submit id="writebtn" value="게시글 작성" class="w3-button w3-block w3-orange w3-ripple w3-margin-top w3-round">
