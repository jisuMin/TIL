...
<td style="text-align: center">
	<div class="w3-content w3-container w3-margin-top">
		<h3 class="w3-h3">${sessionID}님 환영합니다!</h3>
		<h4><a href="mypage?id=${sessionID}" style="text-decoration: none"><input type=button value="마이페이지" class="w3-button w3-block w3-orange w3-ripple w3-margin-top w3-round"></a></h4>
		<h4><a href="productwrite" style="text-decoration: none"><input type=button value="물건 등록하기" class="w3-button w3-block w3-orange w3-ripple w3-margin-top w3-round"></a></h4>
		<h4><a href="logout" style="text-decoration: none"><input type=button value="로그아웃" class="w3-button w3-block w3-orange w3-ripple w3-margin-top w3-round"></a></h4>
	</div>
</td>
</tr>
