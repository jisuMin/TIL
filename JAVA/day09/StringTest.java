...
class StringTest {
  public static void main(String[] args) {
	...
	//charAt[0]은 리턴타입이 char이기 떄문에 여기선 substring을 사용한다. 
	firstInit = first.substring(0,1); //대문자 A 가져옴 substring(a,b) = a 인덱스부터 b 인덱스 전까지
	middleInit = first.substring(0,1);
	lastInit = first.substring(0,1);
